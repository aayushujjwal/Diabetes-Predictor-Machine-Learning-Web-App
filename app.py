...
df = pd.read_csv(r'D:\EDUC\PythonProject\Diabetes_Prediction-master\Diabetes_Prediction\diabetes.csv')
...
def user_report():
  ...
  dpf = st.sidebar.slider('Diabetes Pedigree Function', 0.0,2.4, 0.47 )# occurrence of diabetes within a family.
